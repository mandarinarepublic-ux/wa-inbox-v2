...
export const config = {
  matcher: [
    ...
    // sesión".
    '/((?!api/webhook|api/social/webhook|api/cron/seguimientos|api/cron/pendientes|api/cron/entregas|api/cron/pagos|api/cron/flujos|api/pago-dlocal|_next/static|_next/image|opus/|favicon.ico|sw.js|icon-|manifest.webmanifest).*)',
  ],
}
