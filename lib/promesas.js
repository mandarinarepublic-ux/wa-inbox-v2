...
const PATRONES = [
  ...
  /\b(le |te )?(envio|mando|enviamos|mandamos|paso|confirmo|aviso|escribo) (mas tarde|en un momento|en un rato|enseguida|manana|hoy|en la tarde|en la noche|apenas)\b/,
  /\b(le |te )?(aviso|escribo|confirmo) (apenas|cuando)\b/,
  // "mañana le enviamos…" (falso negativo del 23-sep): el plural también promete.
  /\b(hoy|manana) (sale|se envia|se despacha|le llega|te llega|le envio|te envio|le mando|te mando|le enviamos|te enviamos|le mandamos|te mandamos|le confirmo|te confirmo)\b/,
