 ...
 */
export async function enviarAudioUrl(telefono, nombre, audioUrl, canal = '') {
  return postSaliente({
...
export async function enviarDocumentoUrl(telefono, nombre, docUrl, nombreArchivo = '', canal = '') {
  return postSaliente({
    Telefono: telefono, Nombre: nombre,
    DocURL: docUrl,
