...
export const CANALES = [
  ...
  {
    id: 'REPUBLIC',
    // 25-sep-2026: REPUBLIC dejó la coexistencia (quedó ON_PREMISE desde el
    // 6-sep y no se pudo reconectar). Se eliminó la cuenta del celular, Meta
    // borró el número viejo (118582961194601) Y su WABA (110133805380815), y el
    // 4167 se agregó como Cloud API pura en la WABA de MANDI. Comparte WABA y
    // plantillas con MANDI; cada número conserva su nombre y su calidad.
    phoneId: process.env.META_PHONE_ID_REPUBLIC || '1367772133078101',
    wabaId: process.env.META_WABA_ID_REPUBLIC || '1250794910496982',
    etiqueta: 'REPUBLIC',
    sub: 'WhatsApp',
    color: '#f97316',
