...
import { getSupabase, CUENTA, soloDigitos } from './supabase.js'
...
async function getConvId(telefono, nombre = '', waId = '') {
  ...
  // upsert por (cuenta, telefono): no pisa estado/alias/nombre editados.
 ...
 *           direccion('ENTRANTE'|'SALIENTE'), mediaId, respuestaIA, imagenProducto, contextoId }
 */
