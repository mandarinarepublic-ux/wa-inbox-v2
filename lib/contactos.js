...
export async function marcarAvisoAnuncio(sourceId) {
  if (typeof SB.marcarAvisoAnuncioSupabase !== 'function') return { ok: false }
  return SB.marcarAvisoAnuncioSupabase(sourceId)
}
export async function getAnunciosResumen() {
  if (typeof SB.getAnunciosResumenSupabase !== 'function') return { ok: false }
